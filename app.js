document.addEventListener('DOMContentLoaded', () => {
    ...
    // Crée les boutons de navigation des semaines
    ...
    // Affiche les recettes pour la semaine sélectionnée
    function renderWeek(weekIndex) {
        ...
        week.days.forEach(day => {
            ...
            day.meals.forEach(meal => {
                ...
                // AJOUT des classes pour la couleur du jour et du repas
                const dayClass = meal.day.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace('é', 'e');
                const mealClass = meal.meal.toLowerCase();
                recipeCard.classList.add(`card-${dayClass}`);
                recipeCard.classList.add(`card-${mealClass}`);
                // FIN de l'ajout
                ...
                daySection.appendChild(recipeCard);
            });
